...
void commands::InitializeCommands()
{
	...
	qol_realfps = game::Cvar_RegisterInt("qol_realfps", 0, 0, 1000, game::dvar_flags::saved, "Rendering FPS cap, com_maxfps will control the physics simulation FPS. qol_independentphysics needs to be enabled.");
    ...
    qol_interpolatephysics = game::Cvar_RegisterBool("qol_interpolatephysics", 0, game::dvar_flags::saved, "Enable physics interpolation, qol_independentphysics needs to be enabled. Adds noticeable input latency.");
