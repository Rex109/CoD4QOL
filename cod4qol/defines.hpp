...
#define COD4QOL_BASE_VERSION "1.9.0"
#ifndef _DEBUG
...
inline const std::vector<std::string> supported_cod4x_crc32 = { COD4QOL_COD4X_CRC32_213, COD4QOL_COD4X_CRC32_212, COD4QOL_COD4X_CRC32_211 };